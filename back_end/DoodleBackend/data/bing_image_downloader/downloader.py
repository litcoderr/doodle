...
def download(query, prefix, limit=100, output_dir='dataset', adult_filter_off=True, force_replace=False, timeout=60,):
    ...
    bing = Bing(query, prefix, limit, output_dir, adult, timeout)
    bing.run()
